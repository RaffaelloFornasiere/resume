...
\cvsection{Summary}{
    \item I am a software engineer and ML practitioner with experience in LLM integration, agent development, and hands-on ML engineering.
    I have built AI-powered applications in healthcare and research contexts, trained language models up to 1B parameters, and built data pipelines at scale.
    I am currently doing AI safety research at LASR Labs, having completed ARENA 7.0 where I was awarded 1st prize at the interpretability hackathon.
}

\cvsection{Professional Experience}{
    \item \textbf{LASR Labs Mentee}, LASR Labs (January 2026 – April 2026, upcoming)
    \begin{itemize}
    ...
    \item \textbf{ARENA 7.0 Mentee}, ARENA (January 2026 – February 2026, upcoming)
    \begin{itemize}
...
\cvsection{Technical Skills}{
    ...
    \begin{itemize}
        ...
        \item Libraries: PyTorch, LangChain, llamacpp, Hugging Face Transformers, TensorFlow.
        \item ML Engineering: model fine-tuning (SFT, DPO) up to 1B parameters, data pipelines up to 1B tokens, probes and linear classifiers for mechanistic interpretability.
        \item Background in CNNs, RNNs, transformers, and optimization methods.
    \end{itemize}
