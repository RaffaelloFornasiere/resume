...
\cvsection{Technical Skills}{
    ...
    \begin{itemize}
        ...
        \item Trained language models up to 1B parameters (SFT, DPO), built data pipelines processing up to 1B tokens, trained probes and linear classifiers for mechanistic interpretability.
